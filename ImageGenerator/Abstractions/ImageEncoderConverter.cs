...
{
    public class ImageEncoderConverter : TypeConverter
    {
        ...
        {
            return typeof(ImageEncoder).GetProperties(BindingFlags.Static | BindingFlags.Public);
        }
